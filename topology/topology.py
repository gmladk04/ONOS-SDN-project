...
def topology(args):
    ...
    h2 = net.addHost('h2', cls=Host, mac='00:00:00:00:00:02', ip='10.0.0.2/8') #router
    ...
    #h2.cmd("ifconfig h2-eth0 inet add 1219:1234:1234::101:101:101:101/128")
    ...
    #h2.cmd("ip -6 route add default dev h2-eht0")
