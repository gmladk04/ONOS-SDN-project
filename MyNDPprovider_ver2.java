...
public class MyNdpProvider extends AbstractProvider {
        ...
        public void process(PacketContext context) {
            ...
            if(eth.getEtherType()==(short)0x86dd && ipv6.getNextHeader()==17 && udp.getDestinationPort()==12345) {
                ...
                if(ns.getCode()==0){ //Registration
                    ...
                    // modify LBR 's flow rule
                    // modifyFlowRuleOfLbr2(DeviceId.deviceId("of:0000000000000003"), targetAddr2, rsuIpDB.get(DeviceId.deviceId("of:1000000000000002"))); // Change to the RSU which received the NS
                    // modify RSU's flow rule
                    //modifyFlowRuleOfRsu2(rsuIpDB.get(deviceId), targetAddr); // Change to deviceId and targetAddr
    ...
    private void modifyFlowRuleOfRsu2(DeviceId deviceId, IpAddress target) {
    ...
    private void modifyFlowRuleOfLbr2(DeviceId deviceId, IpAddress target, IpAddress ipv6) {
