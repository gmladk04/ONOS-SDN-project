...
public class AppComponent{
    ...
    private void sendPacket2() {
        Ethernet ethPacket = new Ethernet();
        WsaFrame3 wsa = new WsaFrame3();

        ethPacket.setEtherType((short)0x88dc);
        ethPacket.setSourceMACAddress(MacAddress.valueOf("12:eb:d8:f4:17:84")).setPayload(wsa);
        ethPacket.setDestinationMACAddress(MacAddress.valueOf("ff:ff:ff:ff:ff:ff"));
        ethPacket.setPad(true);
    ...
    private void sendPacket3() {
        Ethernet ethPacket = new Ethernet();
        WsaFrame2 wsa = new WsaFrame2();

        ethPacket.setEtherType((short)0x88dc);
        ethPacket.setSourceMACAddress(MacAddress.valueOf("22:eb:d8:f4:17:84")).setPayload(wsa);
        ethPacket.setDestinationMACAddress(MacAddress.valueOf("ff:ff:ff:ff:ff:ff"));
        ethPacket.setPad(true);
