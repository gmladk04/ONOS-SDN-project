...
def topology(args):
    ...
    ap3 = net.addAccessPoint('ap3', cls=OVSKernelAP, ssid='ap3-ssid', mode='g', channel='1',
                             position='103,70,0')
    sta1 = net.addStation('sta1', wlan=3, mac='00:00:00:00:00:04', ip='10.0.0.4/8')
    ...
    ap2sta1 = {'bw':80 }
    net.addLink(ap2, sta1, **ap2sta1)
    ap3sta1 = {'bw':80 }
    net.addLink(ap3, sta1, **ap3sta1)
    
    if '-p' not in args:
        net.plotGraph(max_x=200,max_y=200) 
    #net.addLink(sta1, cls=ITSLink,  channel=176)
    ...
    net.mobility(sta1, 'stop', time=50, **p2)
